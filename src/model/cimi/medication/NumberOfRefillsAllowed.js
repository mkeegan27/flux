...
/**
 * Generated class for cimi.medication.NumberOfRefillsAllowed.
 */
class NumberOfRefillsAllowed {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/medication/NumberOfRefillsAllowed' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-medication-NumberOfRefillsAllowed-extension';
