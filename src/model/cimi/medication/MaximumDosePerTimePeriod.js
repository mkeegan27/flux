...
/**
 * Generated class for cimi.medication.MaximumDosePerTimePeriod.
 */
class MaximumDosePerTimePeriod {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/medication/MaximumDosePerTimePeriod' } };
    if (this.value != null) {
