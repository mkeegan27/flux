...
/**
 * Generated class for cimi.medication.DoseInstructionsText.
 */
class DoseInstructionsText {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/medication/DoseInstructionsText' } };
    if (this.value != null) {
