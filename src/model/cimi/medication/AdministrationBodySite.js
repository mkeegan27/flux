...
/**
 * Generated class for cimi.medication.AdministrationBodySite.
 */
class AdministrationBodySite {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/medication/AdministrationBodySite' } };
    if (this.value != null) {
