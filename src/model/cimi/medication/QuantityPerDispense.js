...
/**
 * Generated class for cimi.medication.QuantityPerDispense.
 */
class QuantityPerDispense {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/medication/QuantityPerDispense' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-medication-QuantityPerDispense-extension';
