...
/**
 * Generated class for cimi.medication.Dosage.
 */
class Dosage {

  /**
   * Get the DoseAmount.
   * @returns {DoseAmount} The cimi.medication.DoseAmount
   */
  get doseAmount() {
   ...
   * @param {DoseAmount} doseAmount - The cimi.medication.DoseAmount
   */
   ...
   * @returns {TimingOfDoses} The cimi.medication.TimingOfDoses
   */
  get timingOfDoses() {
   ...
   * This field/value is required.
   * @param {TimingOfDoses} timingOfDoses - The cimi.medication.TimingOfDoses
   */
   ...
   * @returns {AsNeededIndicator} The cimi.medication.AsNeededIndicator
   */
   ...
   * This field/value is required.
   * @param {AsNeededIndicator} asNeededIndicator - The cimi.medication.AsNeededIndicator
   */
   ...
   * @returns {DoseInstructionsText} The cimi.medication.DoseInstructionsText
   */
   ...
   * @param {DoseInstructionsText} doseInstructionsText - The cimi.medication.DoseInstructionsText
   */
   ...
   * @returns {Array<AdditionalDoseInstruction>} The cimi.medication.AdditionalDoseInstruction array
   */
   ...
   * @param {Array<AdditionalDoseInstruction>} additionalDoseInstruction - The cimi.medication.AdditionalDoseInstruction array
   */
   ...
   * @returns {AdministrationMethod} The cimi.medication.AdministrationMethod
   */
   ...
   * @param {AdministrationMethod} administrationMethod - The cimi.medication.AdministrationMethod
   */
   ...
   * @returns {AdministrationBodySite} The cimi.medication.AdministrationBodySite
   */
   ...
   * @param {AdministrationBodySite} administrationBodySite - The cimi.medication.AdministrationBodySite
   */
   ...
   * @returns {MaximumDosePerTimePeriod} The cimi.medication.MaximumDosePerTimePeriod
   */
   ...
   * @param {MaximumDosePerTimePeriod} maximumDosePerTimePeriod - The cimi.medication.MaximumDosePerTimePeriod
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/medication/Dosage' } };
  ...
  toFHIR(asExtension=false) {
    ...
    if (this.administrationBodySite != null && this.administrationBodySite.anatomicalLocation != null) {
      inst['site'] = typeof this.administrationBodySite.anatomicalLocation.toFHIR === 'function' ? this.administrationBodySite.anatomicalLocation.toFHIR() : this.administrationBodySite.anatomicalLocation;
    }
    if (this.routeIntoBody != null) {
    ...
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-medication-Dosage-extension';
