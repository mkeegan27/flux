...
/**
 * Generated class for cimi.element.Identifier.
 */
class Identifier {
  ...
  /**
   * Get the Issuer.
   * @returns {Issuer} The cimi.element.Issuer
   */
  get issuer() {
    return this._issuer;
  }
  ...
  /**
   * Set the Issuer.
   * @param {Issuer} issuer - The cimi.element.Issuer
   */
  set issuer(issuer) {
    this._issuer = issuer;
  }
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/element/Identifier' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    ...
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-element-Identifier-extension';
