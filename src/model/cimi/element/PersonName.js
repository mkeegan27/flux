...
/**
 * Generated class for cimi.element.PersonName.
 * @extends Name
 */
class PersonName extends Name {
   ...
   * @returns {Array<Prefix>} The cimi.element.Prefix array
   */
  get prefix() {
    return this._prefix;
  }
   ...
   * @param {Array<Prefix>} prefix - The cimi.element.Prefix array
   */
  set prefix(prefix) {
    this._prefix = prefix;
  }
   ...
   * @returns {Array<GivenName>} The cimi.element.GivenName array
   */
  get givenName() {
   ...
   * @param {Array<GivenName>} givenName - The cimi.element.GivenName array
   */
   ...
   * @returns {Array<MiddleName>} The cimi.element.MiddleName array
   */
  get middleName() {
   ...
   * @param {Array<MiddleName>} middleName - The cimi.element.MiddleName array
   */
   ...
   * @returns {Array<FamilyName>} The cimi.element.FamilyName array
   */
  get familyName() {
   ...
   * @param {Array<FamilyName>} familyName - The cimi.element.FamilyName array
   */
   ...
   * @returns {Array<Suffix>} The cimi.element.Suffix array
   */
  get suffix() {
    return this._suffix;
  }
   ...
   * @param {Array<Suffix>} suffix - The cimi.element.Suffix array
   */
  set suffix(suffix) {
    this._suffix = suffix;
  }
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/element/PersonName' } };
