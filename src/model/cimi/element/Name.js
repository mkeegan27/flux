...
/**
 * Generated class for cimi.element.Name.
 */
class Name {

  /**
   * Get the NameAsText.
   * @returns {NameAsText} The cimi.element.NameAsText
   */
  get nameAsText() {
  ...
  /**
   * Set the NameAsText.
   * @param {NameAsText} nameAsText - The cimi.element.NameAsText
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/element/Name' } };
