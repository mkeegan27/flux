...
/**
 * Generated class for cimi.element.Annotation.
 */
class Annotation {
  ...
  /**
   * Get the Author.
   * @returns {Author} The cimi.element.Author
   */
  get author() {
    return this._author;
  }
   ...
   * Set the Author.
   * This field/value is required.
   * @param {Author} author - The cimi.element.Author
   */
  set author(author) {
    this._author = author;
  }
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/element/Annotation' } };
    if (this.value != null) {
