...
/**
 * Generated class for cimi.element.Signature.
 */
class Signature {

  /**
   * Get the SignatureType array.
   * @returns {Array<SignatureType>} The cimi.element.SignatureType array
   */
  get signatureType() {
   ...
   * @param {Array<SignatureType>} signatureType - The cimi.element.SignatureType array
   */
  ...
  /**
   * Get the Signatory.
   * @returns {Signatory} The cimi.element.Signatory
   */
  get signatory() {
   ...
   * Set the Signatory.
   * This field/value is required.
   * @param {Signatory} signatory - The cimi.element.Signatory
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/element/Signature' } };
  ...
  toFHIR(asExtension=false) {
    ...
    if (this.signatureType != null) {
      inst['type'] = inst ['type'] || [];
      inst['type'].concat(this.signatureType.map(f => typeof f.toFHIR === 'function' ? f.toFHIR() : f));
    }
    if (this.creationTime != null) {
