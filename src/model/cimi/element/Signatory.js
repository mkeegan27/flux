...
/**
 * Generated class for cimi.element.Signatory.
 */
class Signatory {

  /**
   * Get the choice value; one of: uri, cimi.entity.Entity reference.
   * @returns {(uri|Reference)} The choice value; one of: uri, cimi.entity.Entity reference
   */
  get value() {
    return this._value;
  }
  ...
  /**
   * Set the choice value; one of: uri, cimi.entity.Entity reference.
   * This field/value is required.
   * @param {(uri|Reference)} value - The choice value; one of: uri, cimi.entity.Entity reference
   */
  set value(value) {
    this._value = value;
  }
  ...
  /**
   * Set the choice value; one of: uri, cimi.entity.Entity reference and return 'this' for chaining.
   * This field/value is required.
   * @param {(uri|Reference)} value - The choice value; one of: uri, cimi.entity.Entity reference
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/element/Signatory' } };
    if (this.value != null) {
