...
/**
 * Generated class for cimi.context.WhenClinicallyRecognized.
 */
class WhenClinicallyRecognized {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/context/WhenClinicallyRecognized' } };
    if (this.value != null) {
