...
/**
 * Generated class for cimi.context.Outcome.
 */
class Outcome {
  ...
  /**
   * Get the cimi.statement.ClinicalStatement reference array.
   * @returns {Array<Reference>} The cimi.statement.ClinicalStatement reference array
   */
  ...
  /**
   * Set the cimi.statement.ClinicalStatement reference array.
   * @param {Array<Reference>} clinicalStatement - The cimi.statement.ClinicalStatement reference array
   */
  ...
  /**
   * Set the cimi.statement.ClinicalStatement reference array and return 'this' for chaining.
   * @param {Array<Reference>} clinicalStatement - The cimi.statement.ClinicalStatement reference array
   * @returns {Outcome} this.
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/context/Outcome' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    ...
    if (asExtension) {
      ...
      inst['extension'] = inst['extension'] || [];
      inst['extension'].push(this.clinicalStatement.toFHIR(true));
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-context-Outcome-extension';
    }
