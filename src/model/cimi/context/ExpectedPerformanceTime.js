...
/**
 * Generated class for cimi.context.ExpectedPerformanceTime.
 */
class ExpectedPerformanceTime {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/context/ExpectedPerformanceTime' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-context-ExpectedPerformanceTime-extension';
    }
