...
/**
 * Generated class for cimi.context.ExpectedMethod.
 */
class ExpectedMethod {

  /**
   * Get the value (aliases method).
   * @returns {Reference} The cimi.context.Method reference
   */
  get value() {
    return this._method;
  }
   ...
   * @param {Reference} value - The cimi.context.Method reference
   */
  set value(value) {
    this._method = value;
  }
  ...
  /**
   * Get the cimi.context.Method reference.
   * @returns {Reference} The cimi.context.Method reference
   */
  get method() {
    return this._method;
  ...
  /**
   * Set the cimi.context.Method reference.
   * This field/value is required.
   * @param {Reference} method - The cimi.context.Method reference
   */
  set method(method) {
    this._method = method;
  }
  ...
  /**
   * Set the cimi.context.Method reference and return 'this' for chaining.
   * This field/value is required.
   * @param {Reference} method - The cimi.context.Method reference
   * @returns {ExpectedMethod} this.
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/context/ExpectedMethod' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    ...
    if (asExtension) {
      ...
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-context-ExpectedMethod-extension';
    }
