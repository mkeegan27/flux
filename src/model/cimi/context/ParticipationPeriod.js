...
/**
 * Generated class for cimi.context.ParticipationPeriod.
 */
class ParticipationPeriod {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/context/ParticipationPeriod' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-context-ParticipationPeriod-extension';
