...
/**
 * Generated class for cimi.allergy.AdverseSensitivityTopic.
...
class AdverseSensitivityTopic extends AssertionTopic {
   ...
   * @returns {AllergenIrritant} The cimi.allergy.AllergenIrritant
   */
   ...
   * @param {AllergenIrritant} allergenIrritant - The cimi.allergy.AllergenIrritant
   */
   ...
   * @returns {Array<SubstanceCategory>} The cimi.allergy.SubstanceCategory array
   */
   ...
   * @param {Array<SubstanceCategory>} substanceCategory - The cimi.allergy.SubstanceCategory array
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/allergy/AdverseSensitivityTopic' } };
  ...
  /**
   * Serializes an instance of the AdverseSensitivityTopic class to a FHIR object.
   * The FHIR is expected to be valid against the AdverseSensitivityTopic FHIR profile, but no validation checks are performed.
