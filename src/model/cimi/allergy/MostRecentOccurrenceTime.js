...
/**
 * Generated class for cimi.allergy.MostRecentOccurrenceTime.
 */
class MostRecentOccurrenceTime {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/allergy/MostRecentOccurrenceTime' } };
    if (this.value != null) {
