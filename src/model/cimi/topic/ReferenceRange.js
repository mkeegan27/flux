...
/**
 * Generated class for cimi.topic.ReferenceRange.
 */
class ReferenceRange {
   ...
   * @returns {ApplicableSubpopulation} The cimi.topic.ApplicableSubpopulation
   */
   ...
   * @param {ApplicableSubpopulation} applicableSubpopulation - The cimi.topic.ApplicableSubpopulation
   */
   ...
   * @returns {ApplicableAgeRange} The cimi.topic.ApplicableAgeRange
   */
   ...
   * @param {ApplicableAgeRange} applicableAgeRange - The cimi.topic.ApplicableAgeRange
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/topic/ReferenceRange' } };
    if (this.value != null) {
