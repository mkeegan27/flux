...
/**
 * Generated class for cimi.topic.AlleviatingFactor.
 */
class AlleviatingFactor {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/topic/AlleviatingFactor' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-topic-AlleviatingFactor-extension';
