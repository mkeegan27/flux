...
/**
 * Generated class for cimi.entity.LanguageUsed.
 */
class LanguageUsed {
   ...
   * @returns {SpokenLanguageProficiency} The cimi.entity.SpokenLanguageProficiency
   */
   ...
   * @param {SpokenLanguageProficiency} spokenLanguageProficiency - The cimi.entity.SpokenLanguageProficiency
   */
   ...
   * @returns {WrittenLanguageProficiency} The cimi.entity.WrittenLanguageProficiency
   */
   ...
   * @param {WrittenLanguageProficiency} writtenLanguageProficiency - The cimi.entity.WrittenLanguageProficiency
   */
   ...
   * @returns {Array<LanguageQualifier>} The cimi.entity.LanguageQualifier array
   */
   ...
   * @param {Array<LanguageQualifier>} languageQualifier - The cimi.entity.LanguageQualifier array
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/LanguageUsed' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    ...
    if (asExtension) {
      ...
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-entity-LanguageUsed-extension';
    }
