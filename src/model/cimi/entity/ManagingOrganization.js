...
/**
 * Generated class for cimi.entity.ManagingOrganization.
 */
class ManagingOrganization {

  /**
   * Get the value (aliases organization).
   * @returns {Reference} The cimi.entity.Organization reference
   */
  get value() {
   ...
   * @param {Reference} value - The cimi.entity.Organization reference
   */
  set value(value) {
  ...
  /**
   * Get the cimi.entity.Organization reference.
   * @returns {Reference} The cimi.entity.Organization reference
   */
  get organization() {
    return this._organization;
  ...
  /**
   * Set the cimi.entity.Organization reference.
   * This field/value is required.
   * @param {Reference} organization - The cimi.entity.Organization reference
   */
  ...
  /**
   * Set the cimi.entity.Organization reference and return 'this' for chaining.
   * This field/value is required.
   * @param {Reference} organization - The cimi.entity.Organization reference
   * @returns {ManagingOrganization} this.
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/ManagingOrganization' } };
    if (this.value != null) {
