...
/**
 * Generated class for cimi.entity.MedicalInterpreterNeeded.
 */
class MedicalInterpreterNeeded {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/MedicalInterpreterNeeded' } };
    if (this.value != null) {
