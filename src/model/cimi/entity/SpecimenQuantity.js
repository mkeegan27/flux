...
/**
 * Generated class for cimi.entity.SpecimenQuantity.
 */
class SpecimenQuantity {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/SpecimenQuantity' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-entity-SpecimenQuantity-extension';
