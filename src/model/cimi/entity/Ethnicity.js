...
/**
 * Generated class for cimi.entity.Ethnicity.
 */
class Ethnicity {
   ...
   * @returns {Array<EthnicityDetail>} The cimi.entity.EthnicityDetail array
   */
  get ethnicityDetail() {
   ...
   * @param {Array<EthnicityDetail>} ethnicityDetail - The cimi.entity.EthnicityDetail array
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/Ethnicity' } };
    if (this.value != null) {
