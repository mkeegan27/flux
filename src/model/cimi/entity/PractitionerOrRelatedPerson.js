...
/**
 * Generated class for cimi.entity.PractitionerOrRelatedPerson.
 * @extends EntityOrRole
 */
class PractitionerOrRelatedPerson extends EntityOrRole {

  /**
   * Get the choice value; one of: cimi.entity.Practitioner reference, cimi.entity.RelatedPerson reference.
   * @returns {Reference} The choice value; one of: cimi.entity.Practitioner reference, cimi.entity.RelatedPerson reference
   */
  get value() {
    return this._value;
  }
  ...
  /**
   * Set the choice value; one of: cimi.entity.Practitioner reference, cimi.entity.RelatedPerson reference.
   * This field/value is required.
   * @param {Reference} value - The choice value; one of: cimi.entity.Practitioner reference, cimi.entity.RelatedPerson reference
   */
  set value(value) {
    this._value = value;
  }
  ...
  /**
   * Set the choice value; one of: cimi.entity.Practitioner reference, cimi.entity.RelatedPerson reference and return 'this' for chaining.
   * This field/value is required.
   * @param {Reference} value - The choice value; one of: cimi.entity.Practitioner reference, cimi.entity.RelatedPerson reference
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/PractitionerOrRelatedPerson' } };
    if (this.value != null) {
