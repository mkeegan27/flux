...
/**
 * Generated class for cimi.entity.Deceased.
 */
class Deceased {
  ...
  /**
   * Get the DateOfDeath.
   * @returns {DateOfDeath} The cimi.entity.DateOfDeath
   */
  get dateOfDeath() {
  ...
  /**
   * Set the DateOfDeath.
   * @param {DateOfDeath} dateOfDeath - The cimi.entity.DateOfDeath
   */
  ...
  /**
   * Get the AgeAtDeath.
   * @returns {AgeAtDeath} The cimi.entity.AgeAtDeath
   */
  get ageAtDeath() {
  ...
  /**
   * Set the AgeAtDeath.
   * @param {AgeAtDeath} ageAtDeath - The cimi.entity.AgeAtDeath
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/Deceased' } };
    if (this.value != null) {
