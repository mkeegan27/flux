...
/**
 * Generated class for cimi.entity.Brand.
 */
class Brand {
  ...
  /**
   * Get the BrandName.
   * @returns {BrandName} The cimi.entity.BrandName
   */
  get brandName() {
  ...
  /**
   * Set the BrandName.
   * @param {BrandName} brandName - The cimi.entity.BrandName
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/Brand' } };
    if (this.value != null) {
