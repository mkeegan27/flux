...
/**
 * Generated class for cimi.entity.SourceSpecimen.
 */
class SourceSpecimen {
   ...
   * @param {Reference} value - The cimi.entity.Specimen reference
   */
  set value(value) {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/SourceSpecimen' } };
    if (this.value != null) {
