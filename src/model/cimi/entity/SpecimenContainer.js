...
/**
 * Generated class for cimi.entity.SpecimenContainer.
 * @extends Entity
 */
class SpecimenContainer extends Entity {
  ...
  /**
   * Get the Capacity.
   * @returns {Capacity} The cimi.entity.Capacity
   */
  get capacity() {
  ...
  /**
   * Set the Capacity.
   * @param {Capacity} capacity - The cimi.entity.Capacity
   */
   ...
   * @returns {SpecimenQuantity} The cimi.entity.SpecimenQuantity
   */
   ...
   * @param {SpecimenQuantity} specimenQuantity - The cimi.entity.SpecimenQuantity
   */
   ...
   * @returns {SequenceNumber} The cimi.entity.SequenceNumber
   */
  get sequenceNumber() {
   ...
   * @param {SequenceNumber} sequenceNumber - The cimi.entity.SequenceNumber
   */
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/SpecimenContainer' };
    if (this.type != null) {
