...
/**
 * Generated class for cimi.entity.DriversLicenseNumber.
 */
class DriversLicenseNumber {
   ...
   * @returns {StateOfIssue} The cimi.entity.StateOfIssue
   */
  get stateOfIssue() {
   ...
   * @param {StateOfIssue} stateOfIssue - The cimi.entity.StateOfIssue
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/DriversLicenseNumber' } };
    if (this.value != null) {
