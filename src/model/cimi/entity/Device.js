...
/**
 * Generated class for cimi.entity.Device.
 * @extends Entity
 */
class Device extends Entity {
   ...
   * @returns {Array<DeviceUdi>} The cimi.entity.DeviceUdi array
   */
  get deviceUdi() {
   ...
   * @param {Array<DeviceUdi>} deviceUdi - The cimi.entity.DeviceUdi array
   */
   ...
   * @returns {VendorModelNumber} The cimi.entity.VendorModelNumber
   */
   ...
   * @param {VendorModelNumber} vendorModelNumber - The cimi.entity.VendorModelNumber
   */
   ...
   * @returns {ManufacturerName} The cimi.entity.ManufacturerName
   */
   ...
   * @param {ManufacturerName} manufacturerName - The cimi.entity.ManufacturerName
   */
   ...
   * @returns {ManufactureDate} The cimi.entity.ManufactureDate
   */
  get manufactureDate() {
   ...
   * @param {ManufactureDate} manufactureDate - The cimi.entity.ManufactureDate
   */
  ...
  /**
   * Get the Url.
   * @returns {Url} The cimi.entity.Url
   */
  get url() {
    return this._url;
  }
  ...
  /**
   * Set the Url.
   * @param {Url} url - The cimi.entity.Url
   */
  set url(url) {
    this._url = url;
  }
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/Device' } };
    if (this.type != null) {
  ...
  toFHIR(asExtension=false) {
    ...
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-entity-Device-extension';
