...
/**
 * Generated class for cimi.entity.MedicationIngredient.
 */
class MedicationIngredient {

  /**
   * Get the choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference, cimi.entity.Medication reference.
   * @returns {(CodeableConcept|Reference)} The choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference, cimi.entity.Medication reference
   */
  get value() {
    return this._value;
  }
  ...
  /**
   * Set the choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference, cimi.entity.Medication reference.
   * This field/value is required.
   * @param {(CodeableConcept|Reference)} value - The choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference, cimi.entity.Medication reference
   */
  set value(value) {
    this._value = value;
  }
  ...
  /**
   * Set the choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference, cimi.entity.Medication reference and return 'this' for chaining.
   * This field/value is required.
   * @param {(CodeableConcept|Reference)} value - The choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference, cimi.entity.Medication reference
   ...
   * @returns {IngredientAmount} The cimi.entity.IngredientAmount
   */
   ...
   * This field/value is required.
   * @param {IngredientAmount} ingredientAmount - The cimi.entity.IngredientAmount
   */
   ...
   * @returns {IsActiveIngredient} The cimi.entity.IsActiveIngredient
   */
   ...
   * This field/value is required.
   * @param {IsActiveIngredient} isActiveIngredient - The cimi.entity.IsActiveIngredient
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/MedicationIngredient' } };
    if (this.value != null) {
