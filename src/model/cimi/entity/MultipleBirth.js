...
/**
 * Generated class for cimi.entity.MultipleBirth.
 */
class MultipleBirth {
   ...
   * @returns {MultipleBirthOrder} The cimi.entity.MultipleBirthOrder
   */
   ...
   * @param {MultipleBirthOrder} multipleBirthOrder - The cimi.entity.MultipleBirthOrder
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/MultipleBirth' } };
    if (this.value != null) {
