...
import Identifier from '../element/Identifier';

/**
 * Generated class for cimi.entity.NationalProviderIdentifier.
 * @extends Identifier
 */
class NationalProviderIdentifier extends Identifier {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/NationalProviderIdentifier' } };
    if (this.value != null) {
