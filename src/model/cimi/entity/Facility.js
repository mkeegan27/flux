...
/**
 * Generated class for cimi.entity.Facility.
 * @extends Entity
 */
class Facility extends Entity {
   ...
   * @returns {FacilityName} The cimi.entity.FacilityName
   */
  get facilityName() {
   ...
   * @param {FacilityName} facilityName - The cimi.entity.FacilityName
   */
   ...
   * @returns {MobileFacility} The cimi.entity.MobileFacility
   */
  get mobileFacility() {
   ...
   * @param {MobileFacility} mobileFacility - The cimi.entity.MobileFacility
   */
   ...
   * @returns {ManagingOrganization} The cimi.entity.ManagingOrganization
   */
   ...
   * This field/value is required.
   * @param {ManagingOrganization} managingOrganization - The cimi.entity.ManagingOrganization
   */
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/Facility' };
  ...
  toFHIR(asExtension=false) {
    ...
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-entity-Facility-extension';
