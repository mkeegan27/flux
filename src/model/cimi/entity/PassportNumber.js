...
/**
 * Generated class for cimi.entity.PassportNumber.
 */
class PassportNumber {
   ...
   * @returns {CountryOfIssue} The cimi.entity.CountryOfIssue
   */
  get countryOfIssue() {
   ...
   * This field/value is required.
   * @param {CountryOfIssue} countryOfIssue - The cimi.entity.CountryOfIssue
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/PassportNumber' } };
    if (this.value != null) {
