...
/**
 * Generated class for cimi.entity.PatientOrPractitionerOrRelatedPerson.
...
class PatientOrPractitionerOrRelatedPerson extends EntityOrRole {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/PatientOrPractitionerOrRelatedPerson' } };
    if (this.value != null) {
