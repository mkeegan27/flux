...
/**
 * Generated class for cimi.entity.PatientOrPractitioner.
 * @extends EntityOrRole
 */
class PatientOrPractitioner extends EntityOrRole {

  /**
   * Get the choice value; one of: cimi.entity.Patient reference, cimi.entity.Practitioner reference.
   * @returns {Reference} The choice value; one of: cimi.entity.Patient reference, cimi.entity.Practitioner reference
   */
  get value() {
    return this._value;
  }
  ...
  /**
   * Set the choice value; one of: cimi.entity.Patient reference, cimi.entity.Practitioner reference.
   * This field/value is required.
   * @param {Reference} value - The choice value; one of: cimi.entity.Patient reference, cimi.entity.Practitioner reference
   */
  set value(value) {
    this._value = value;
  }
  ...
  /**
   * Set the choice value; one of: cimi.entity.Patient reference, cimi.entity.Practitioner reference and return 'this' for chaining.
   * This field/value is required.
   * @param {Reference} value - The choice value; one of: cimi.entity.Patient reference, cimi.entity.Practitioner reference
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/PatientOrPractitioner' } };
    if (this.value != null) {
