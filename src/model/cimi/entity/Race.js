...
/**
 * Generated class for cimi.entity.Race.
 */
class Race {
   ...
   * @returns {Array<RaceDetail>} The cimi.entity.RaceDetail array
   */
  get raceDetail() {
   ...
   * @param {Array<RaceDetail>} raceDetail - The cimi.entity.RaceDetail array
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/Race' } };
    if (this.value != null) {
