...
/**
 * Generated class for cimi.entity.Medication.
 * @extends Entity
 */
class Medication extends Entity {
  ...
  /**
   * Get the DoseForm.
   * @returns {DoseForm} The cimi.entity.DoseForm
   */
  get doseForm() {
  ...
  /**
   * Set the DoseForm.
   * @param {DoseForm} doseForm - The cimi.entity.DoseForm
   */
  ...
  /**
   * Get the Brand.
   * @returns {Brand} The cimi.entity.Brand
   */
  get brand() {
    return this._brand;
  }
  ...
  /**
   * Set the Brand.
   * @param {Brand} brand - The cimi.entity.Brand
   */
  set brand(brand) {
    this._brand = brand;
  }
   ...
   * @returns {OverTheCounter} The cimi.entity.OverTheCounter
   */
  get overTheCounter() {
   ...
   * @param {OverTheCounter} overTheCounter - The cimi.entity.OverTheCounter
   */
   ...
   * @returns {Array<MedicationIngredient>} The cimi.entity.MedicationIngredient array
   */
   ...
   * @param {Array<MedicationIngredient>} medicationIngredient - The cimi.entity.MedicationIngredient array
   */
   ...
   * @returns {Manufacturer} The cimi.entity.Manufacturer
   */
  get manufacturer() {
   ...
   * @param {Manufacturer} manufacturer - The cimi.entity.Manufacturer
   */
  ...
  /**
   * Get the LotNumber.
   * @returns {LotNumber} The cimi.entity.LotNumber
   */
  get lotNumber() {
  ...
  /**
   * Set the LotNumber.
   * @param {LotNumber} lotNumber - The cimi.entity.LotNumber
   */
   ...
   * @returns {ExpirationDate} The cimi.entity.ExpirationDate
   */
  get expirationDate() {
   ...
   * @param {ExpirationDate} expirationDate - The cimi.entity.ExpirationDate
   */
  ...
  /**
   * Get the Package.
   * @returns {Package} The cimi.entity.Package
   */
  get package() {
  ...
  /**
   * Set the Package.
   * @param {Package} packageVar - The cimi.entity.Package
   */
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/Medication' };
    if (this.type != null) {
  ...
  toFHIR(asExtension=false) {
    ...
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-entity-Medication-extension';
