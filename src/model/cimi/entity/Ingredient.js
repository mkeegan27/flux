...
/**
 * Generated class for cimi.entity.Ingredient.
 */
class Ingredient {

  /**
   * Get the choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference.
   * @returns {(CodeableConcept|Reference)} The choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference
   */
  get value() {
    return this._value;
  }
  ...
  /**
   * Set the choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference.
   * This field/value is required.
   * @param {(CodeableConcept|Reference)} value - The choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference
   */
  set value(value) {
    this._value = value;
  }
  ...
  /**
   * Set the choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference and return 'this' for chaining.
   * This field/value is required.
   * @param {(CodeableConcept|Reference)} value - The choice value; one of: shr.core.CodeableConcept, cimi.entity.Substance reference
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/Ingredient' } };
    if (this.value != null) {
