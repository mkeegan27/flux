...
/**
 * Generated class for cimi.entity.Affiliation.
 */
class Affiliation {

  /**
   * Get the value (aliases organization).
   * @returns {Organization} The cimi.entity.Organization
   */
  get value() {
   ...
   * @param {Organization} value - The cimi.entity.Organization
   */
  set value(value) {
   ...
   * This field/value is required.
   * @param {Organization} organization - The cimi.entity.Organization
   */
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/Affiliation' } };
    if (this.value != null) {
