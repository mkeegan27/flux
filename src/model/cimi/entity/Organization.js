...
/**
 * Generated class for cimi.entity.Organization.
 * @extends Entity
 */
class Organization extends Entity {
   ...
   * @returns {OrganizationName} The cimi.entity.OrganizationName
   */
   ...
   * @param {OrganizationName} organizationName - The cimi.entity.OrganizationName
   */
   ...
   * @returns {Array<OrganizationAlias>} The cimi.entity.OrganizationAlias array
   */
   ...
   * @param {Array<OrganizationAlias>} organizationAlias - The cimi.entity.OrganizationAlias array
   */
   ...
   * @returns {Array<OrganizationIdentifier>} The cimi.entity.OrganizationIdentifier array
   */
   ...
   * This field/value is required.
   * @param {Array<OrganizationIdentifier>} organizationIdentifier - The cimi.entity.OrganizationIdentifier array
   */
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/Organization' };
