...
/**
 * Generated class for cimi.entity.ActiveFlagAsaCodeableConcept.
 */
class ActiveFlagAsaCodeableConcept {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/entity/ActiveFlagAsaCodeableConcept' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/cimi-entity-ActiveFlagAsaCodeableConcept-extension';
