...
/**
 * Generated class for cimi.procedure.UsingAccessDevice.
 */
class UsingAccessDevice {
   ...
   * @param {Device} value - The cimi.entity.Device
   */
  set value(value) {
    this._device = value;
  }
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/procedure/UsingAccessDevice' } };
    if (this.value != null) {
