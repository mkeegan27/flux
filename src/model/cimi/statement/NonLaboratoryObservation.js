...
/**
 * Generated class for cimi.statement.NonLaboratoryObservation.
 * @extends Observation
 */
class NonLaboratoryObservation extends Observation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/cimi/statement/NonLaboratoryObservation' };
