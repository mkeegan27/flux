...
/**
 * Generated class for cimi.statement.NonLabPanelRecorded.
 * @extends EvaluationResultRecorded
 */
class NonLabPanelRecorded extends EvaluationResultRecorded {
   ...
   * This field/value is required.
   * @param {PanelTopic} statementTopic - The cimi.topic.PanelTopic
   * @returns {NonLabPanelRecorded} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the NonLabPanelRecorded class.
   * The JSON must be valid against the NonLabPanelRecorded JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {NonLabPanelRecorded} An instance of NonLabPanelRecorded populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new NonLabPanelRecorded();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the NonLabPanelRecorded class to a JSON object.
   * The JSON is expected to be valid against the NonLabPanelRecorded JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/statement/NonLabPanelRecorded' } };
...
export default NonLabPanelRecorded;
