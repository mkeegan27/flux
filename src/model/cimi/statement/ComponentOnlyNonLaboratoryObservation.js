...
/**
 * Generated class for cimi.statement.ComponentOnlyNonLaboratoryObservation.
...
class ComponentOnlyNonLaboratoryObservation extends NonLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/cimi/statement/ComponentOnlyNonLaboratoryObservation' };
