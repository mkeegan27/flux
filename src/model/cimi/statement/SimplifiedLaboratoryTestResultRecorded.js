...
/**
 * Generated class for cimi.statement.SimplifiedLaboratoryTestResultRecorded.
 * @extends LaboratoryTestResultRecorded
 */
class SimplifiedLaboratoryTestResultRecorded extends LaboratoryTestResultRecorded {
   ...
   * This field/value is required.
   * @param {EvaluationResultTopic} statementTopic - The cimi.topic.EvaluationResultTopic
   * @returns {SimplifiedLaboratoryTestResultRecorded} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the SimplifiedLaboratoryTestResultRecorded class.
   * The JSON must be valid against the SimplifiedLaboratoryTestResultRecorded JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {SimplifiedLaboratoryTestResultRecorded} An instance of SimplifiedLaboratoryTestResultRecorded populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new SimplifiedLaboratoryTestResultRecorded();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the SimplifiedLaboratoryTestResultRecorded class to a JSON object.
   * The JSON is expected to be valid against the SimplifiedLaboratoryTestResultRecorded JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/cimi/statement/SimplifiedLaboratoryTestResultRecorded' } };
...
export default SimplifiedLaboratoryTestResultRecorded;
